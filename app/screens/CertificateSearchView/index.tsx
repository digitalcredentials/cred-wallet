...
import { ICertificateSearchViewScreenProps } from './certificate-search-view.props';
...
export const CertificateSearchViewScreen: React.FC<ICertificateSearchViewScreenProps> =
  ({
    // navigation,
    route,
  }) => {
